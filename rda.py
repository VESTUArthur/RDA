...
class RhythmicDataAnalysis:
    """
    A class used to perform Rhythmic Data Analysis programes, such as JTK, ARS, Ls, Cosinor or RIAN.
    ...
    cosinor(filename,sep=',', n_components = 2, period = 24, names = "",folder=None, **kwargs):
    ...
    def cosinor(filename,sep=',', n_components = 2, period = 24,folder=None, **kwargs):
        """  
        Perform Cosinor analysis and store the result in the cosinorpyout folder
        ...
    ...
    def cosinorPop(filename,sep,period):
        """  
