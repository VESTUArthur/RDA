...
def file_rda(filename,metrics=False,y=None,half_rnd=True,n_components=1,replicates=1,sample_rate=2):
        """  
        ...
        """
        meta2d(filename)
        rain(filename,sample_rate=sample_rate,n_replicate=replicates)
